 ...
 *
 *=========================================================================*/
#ifndef __itkV4L2VideoGrabberInterface_h
#define __itkV4L2VideoGrabberInterface_h

// Define support for V4L2 Video
#ifndef ITK_VIDEO_USE_V4L2
#define ITK_VIDEO_USE_V4L2
#endif
...
namespace itk
{
/** \class V4L2VideoGrabberInterface
 *
 * \brief Video grabber interface class using V4L2
 *
 *
 * \ingroup Video-Grabber-V4L2
 *
 */
class ITK_EXPORT V4L2VideoGrabberInterface: public VideoGrabberInterfaceBase
{
public:
  /** Standard class typedefs. */
  typedef V4L2VideoGrabberInterface       Self;
  ...
  itkTypeMacro(V4L2VideoGrabberInterface, Superclass);
   ...
   * V4L2VideoGrabberInterface is used can access the individual file names. This is
...
private:
  V4L2VideoGrabberInterface(const Self &);     //purposely not implemented
...
#endif // __itkV4L2VideoGrabberInterface_h
