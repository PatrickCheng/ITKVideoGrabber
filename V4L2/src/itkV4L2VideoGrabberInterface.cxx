...
// Constructor
//
V4L2VideoGrabberInterface::V4L2VideoGrabberInterface()
{
  this->ResetMembers();
}
...
// PrintSelf
//
void V4L2VideoGrabberInterface::PrintSelf(std::ostream & os, Indent indent) const
{
  Superclass::PrintSelf(os,indent);
  if (!m_ImageIO.IsNull())
    {
    os << indent << "V4L2 video grabber:" << std::endl;
...
bool V4L2VideoGrabberInterface::StopGrabbing()
{
...
//
void V4L2VideoGrabberInterface::FinishReadingOrWriting()
{
  this->ResetMembers();
...
// GetPositionInMSec
//
double V4L2VideoGrabberInterface::GetPositionInMSec()
{
...
// GetRatio
//
double V4L2VideoGrabberInterface::GetRatio()
{
  return m_Ratio;
}
...
// GetFrameTotal
//
unsigned long V4L2VideoGrabberInterface::GetFrameTotal()
{
  return m_FrameTotal;
}
...
// GetFpS
//
double V4L2VideoGrabberInterface::GetFpS()
{
  return m_FpS;
}
...
// GetCurrentFrame
//
unsigned long V4L2VideoGrabberInterface::GetCurrentFrame()
{
...
// GetIFrameInterval
//
unsigned int V4L2VideoGrabberInterface::GetIFrameInterval()
{
...
// GetLastIFrame
//
unsigned long V4L2VideoGrabberInterface::GetLastIFrame()
{
  return m_LastIFrame;
}
...
//
void V4L2VideoGrabberInterface::SetFileName(const char* fileList)
{
...
// SplitFileNames ','
//
std::vector<std::string> V4L2VideoGrabberInterface::SplitFileNames(const char* fileList)
{
...
// SetReadFromFile
//
void V4L2VideoGrabberInterface::SetReadFromFile()
{
...
// SetReadFromCamera
//
void V4L2VideoGrabberInterface::SetReadFromCamera()
{
...
// CanReadFile
//
bool V4L2VideoGrabberInterface::CanReadFile(const char* filename)
{
...
// CanReadCamera
//
bool V4L2VideoGrabberInterface::CanReadGrabber( unsigned long cameraID )
{
  return false;
}
...
//
void V4L2VideoGrabberInterface::ReadImageInformation()
{
  // Open from a file
  ...
  // Open capture from a camera
    ...
    {
    itkExceptionMacro("V4L2VideoGrabber cannot read from a camera");
    }
...
// Read
//
void V4L2VideoGrabberInterface::Read(void *buffer)
{
...
// SetNextFrameToRead
//
bool V4L2VideoGrabberInterface::SetNextFrameToRead(unsigned long frameNumber)
{
...
// GetSpacing
//
double V4L2VideoGrabberInterface::GetSpacing(unsigned int i) const
{
  if (!m_ReaderOpen)
    {
...
// GetOrigin
//
double V4L2VideoGrabberInterface::GetOrigin(unsigned int i) const
{
  if (!m_ReaderOpen)
    {
...
// GetDirection
//
std::vector< double > V4L2VideoGrabberInterface::GetDirection(unsigned int i) const
{
  if (!m_ReaderOpen)
    {
...
// CanWriteFile
//
bool V4L2VideoGrabberInterface::CanWriteFile(const char* filename)
{
...
//
void V4L2VideoGrabberInterface::WriteImageInformation()
{
  if (!m_WriterOpen)
    {
    this->OpenWriter();
...
// SetWriterParameters
//
void V4L2VideoGrabberInterface::SetWriterParameters(double fps, std::vector<SizeValueType> dim,
...
// Write
//
void V4L2VideoGrabberInterface::Write(const void *buffer)
{
...
// OpenReader
//
void V4L2VideoGrabberInterface::OpenReader()
{
  if (m_ReaderOpen)
    {
  ...
  if (m_ReadType == ReadFromFile)
    ...
    {
    itkExceptionMacro("V4L2VideoGrabber doesn't support reading from camera");
    }
}
...
// OpenWriter
//
void V4L2VideoGrabberInterface::OpenWriter()
{
  if (m_WriterOpen)
    {
...
// ResetMembers
//
void V4L2VideoGrabberInterface::ResetMembers()
{
  m_ImageIO = NULL;
  m_FileNames.clear();
  m_WriterOpen = false;
