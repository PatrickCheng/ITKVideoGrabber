...
// PrintSelf
//
void OpenCVVideoGrabber::PrintSelf(std::ostream & os, Indent indent) const
{
...
//
void OpenCVVideoGrabber::FinishReadingOrWriting()
{
...
// GetPositionInMSec
//
double OpenCVVideoGrabber::GetPositionInMSec()
{
...
// GetRatio
//
double OpenCVVideoGrabber::GetRatio()
{
  return this->m_Ratio;
}
...
// GetFrameTotal
//
unsigned long OpenCVVideoGrabber::GetFrameTotal()
{
...
// GetFpS
//
double OpenCVVideoGrabber::GetFpS()
{
  return this->m_FpS;
}
...
// GetCurrentFrame
//
unsigned long OpenCVVideoGrabber::GetCurrentFrame()
{
...
// GetIFrameInterval
//
unsigned int OpenCVVideoGrabber::GetIFrameInterval()
{
...
// GetLastIFrame
//
unsigned long OpenCVVideoGrabber::GetLastIFrame()
{
...
// SetCameraIndex
//
void OpenCVVideoGrabber::SetCameraIndex(int idx)
{
...
// GetCameraIndex
//
int OpenCVVideoGrabber::GetCameraIndex()
{
...
// SetReadFromFile
//
void OpenCVVideoGrabber::SetReadFromFile()
{
...
// SetReadFromCamera
//
void OpenCVVideoGrabber::SetReadFromCamera()
{
  if (!this->m_ReaderOpen && !this->m_WriterOpen)
    {
...
// CanReadFile
//
bool OpenCVVideoGrabber::CanReadFile(const char* filename)
{
...
// CanReadCamera
//
bool OpenCVVideoGrabber::CanReadCamera( unsigned long cameraID )
{
...
//
void OpenCVVideoGrabber::ReadImageInformation()
{
  ...
  if (this->m_NumberOfComponents == 1)
    ...
    {
    itkExceptionMacro("OpenCV Grabber only supports Mono, RGB, and RGBA input");
    }
...
// Read
//
void OpenCVVideoGrabber::Read(void *buffer)
{
...
// SetNextFrameToRead
//
bool OpenCVVideoGrabber::SetNextFrameToRead(unsigned long frameNumber)
{
...
// CanWriteFile
//
bool OpenCVVideoGrabber::CanWriteFile(const char* filename)
{
...
//
void OpenCVVideoGrabber::WriteImageInformation()
{
  // Don't do anything
}
...
// SetWriterParameters
//
void OpenCVVideoGrabber::SetWriterParameters(double fps, std::vector<SizeValueType> dim,
                                        ...
                                        IOComponentType componentType)
{
  ...
  if (componentType != UCHAR)
    {
    itkExceptionMacro("OpenCV Grabber only supports writing video with pixels of UCHAR");
    }

  if (dim.size() != 2)
    {
    itkExceptionMacro("OpenCV Grabber only supports 2D video");
    }
  this->m_Dimensions.clear();
  ...
  if (nChannels == 1)
    ...
    {
    itkExceptionMacro("OpenCV Grabber only supports Mono, RGB, and RGBA output");
    }
}
...
// Write
//
void OpenCVVideoGrabber::Write(const void *buffer)
{
...
//
void OpenCVVideoGrabber::UpdateReaderProperties()
{
  this->m_CurrentFrame = 
...
// OpenReader
//
void OpenCVVideoGrabber::OpenReader()
{
  if (this->m_ReaderOpen)
    {
...
// OpenWriter
//
void OpenCVVideoGrabber::OpenWriter()
{
  if (this->m_WriterOpen)
    {
...
// ResetMembers
//
void OpenCVVideoGrabber::ResetMembers()
{
  this->m_CVImage = 0;
  this->m_TempImage = 0;
  this->m_Capture = 0;
