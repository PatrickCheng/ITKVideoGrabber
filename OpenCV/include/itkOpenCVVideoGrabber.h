 ...
 *
 * \brief VideoGrabber object for reading and writing videos using OpenCV
 *
 * \ingroup Video-Grabber-OpenCV
 */
class ITK_EXPORT OpenCVVideoGrabber:public VideoGrabberBase
{
public:
  /** Standard class typedefs. */
  typedef OpenCVVideoGrabber        Self;
  typedef VideoGrabberBase          Superclass;
  ...
  itkTypeMacro(OpenCVVideoGrabber, Superclass);
  ...
  /** Return whether or not the VideoGrabber can read from a camera */
...
private:
  OpenCVVideoGrabber(const Self &);     //purposely not implemented
...
#endif // __itkOpenCVVideoGrabber_h
