 ...
 *
 *=========================================================================*/
#ifndef __itkLinux1394VideoGrabberInterface_h
#define __itkLinux1394VideoGrabberInterface_h

// Define support for Linux1394 Video
#ifndef ITK_VIDEO_USE_LINUX1394
#define ITK_VIDEO_USE_LINUX1394
#endif
...
namespace itk
{
/** \class Linux1394VideoGrabberInterface
 *
 * \brief Video grabber interface class using Linux1394
 *
 *
 * \ingroup Video-Grabber-Linux1394
 *
 */
class ITK_EXPORT Linux1394VideoGrabberInterface: public VideoGrabberInterfaceBase
{
public:
  /** Standard class typedefs. */
  typedef Linux1394VideoGrabberInterface       Self;
  ...
  itkTypeMacro(Linux1394VideoGrabberInterface, Superclass);
   ...
   * Linux1394VideoGrabberInterface is used can access the individual file names. This is
...
protected:
  Linux1394VideoGrabberInterface();
  ~Linux1394VideoGrabberInterface();
...
private:
  Linux1394VideoGrabberInterface(const Self &);     //purposely not implemented
...
#endif // __itkLinux1394VideoGrabberInterface_h
