...
// Constructor
//
Linux1394VideoGrabberInterface::Linux1394VideoGrabberInterface()
{
  this->ResetMembers();
}
...
// PrintSelf
//
void Linux1394VideoGrabberInterface::PrintSelf(std::ostream & os, Indent indent) const
{
  Superclass::PrintSelf(os,indent);
  if (!m_ImageIO.IsNull())
    {
    os << indent << "Linux1394 video grabber:" << std::endl;
...
bool Linux1394VideoGrabberInterface::StopGrabbing()
{
...
//
void Linux1394VideoGrabberInterface::FinishReadingOrWriting()
{
  this->ResetMembers();
...
// GetPositionInMSec
//
double Linux1394VideoGrabberInterface::GetPositionInMSec()
{
...
// GetRatio
//
double Linux1394VideoGrabberInterface::GetRatio()
{
  return m_Ratio;
}
...
// GetFrameTotal
//
unsigned long Linux1394VideoGrabberInterface::GetFrameTotal()
{
  return m_FrameTotal;
}
...
// GetFpS
//
double Linux1394VideoGrabberInterface::GetFpS()
{
  return m_FpS;
}
...
// GetCurrentFrame
//
unsigned long Linux1394VideoGrabberInterface::GetCurrentFrame()
{
...
// GetIFrameInterval
//
unsigned int Linux1394VideoGrabberInterface::GetIFrameInterval()
{
...
// GetLastIFrame
//
unsigned long Linux1394VideoGrabberInterface::GetLastIFrame()
{
  return m_LastIFrame;
}
...
//
void Linux1394VideoGrabberInterface::SetFileName(const char* fileList)
{
...
// SplitFileNames ','
//
std::vector<std::string> Linux1394VideoGrabberInterface::SplitFileNames(const char* fileList)
{
...
// SetReadFromFile
//
void Linux1394VideoGrabberInterface::SetReadFromFile()
{
...
// SetReadFromCamera
//
void Linux1394VideoGrabberInterface::SetReadFromCamera()
{
...
// CanReadFile
//
bool Linux1394VideoGrabberInterface::CanReadFile(const char* filename)
{
...
// CanReadCamera
//
bool Linux1394VideoGrabberInterface::CanReadGrabber( unsigned long cameraID )
{
  return false;
}
...
//
void Linux1394VideoGrabberInterface::ReadImageInformation()
{
  // Open from a file
  ...
  // Open capture from a camera
    ...
    {
    itkExceptionMacro("Linux1394VideoGrabber cannot read from a camera");
    }
...
// Read
//
void Linux1394VideoGrabberInterface::Read(void *buffer)
{
...
// SetNextFrameToRead
//
bool Linux1394VideoGrabberInterface::SetNextFrameToRead(unsigned long frameNumber)
{
...
// GetSpacing
//
double Linux1394VideoGrabberInterface::GetSpacing(unsigned int i) const
{
  if (!m_ReaderOpen)
    {
...
// GetOrigin
//
double Linux1394VideoGrabberInterface::GetOrigin(unsigned int i) const
{
  if (!m_ReaderOpen)
    {
...
// GetDirection
//
std::vector< double > Linux1394VideoGrabberInterface::GetDirection(unsigned int i) const
{
  if (!m_ReaderOpen)
    {
...
// CanWriteFile
//
bool Linux1394VideoGrabberInterface::CanWriteFile(const char* filename)
{
...
//
void Linux1394VideoGrabberInterface::WriteImageInformation()
{
  if (!m_WriterOpen)
    {
    this->OpenWriter();
...
// SetWriterParameters
//
void Linux1394VideoGrabberInterface::SetWriterParameters(double fps, std::vector<SizeValueType> dim,
...
// Write
//
void Linux1394VideoGrabberInterface::Write(const void *buffer)
{
...
// OpenReader
//
void Linux1394VideoGrabberInterface::OpenReader()
{
  if (m_ReaderOpen)
    {
  ...
  if (m_ReadType == ReadFromFile)
    ...
    {
    itkExceptionMacro("Linux1394VideoGrabber doesn't support reading from camera");
    }
}
...
// OpenWriter
//
void Linux1394VideoGrabberInterface::OpenWriter()
{
  if (m_WriterOpen)
    {
...
// ResetMembers
//
void Linux1394VideoGrabberInterface::ResetMembers()
{
  m_ImageIO = NULL;
  m_FileNames.clear();
  m_WriterOpen = false;
